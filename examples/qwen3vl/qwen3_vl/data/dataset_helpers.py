...
from data.energon.chatml import ChatMLSample
from data.image_processing import get_visual_transform
...
class TaskEncoder(
    ...
    def encode_vqa(self, sample: VQASample):
        ...
        # print("input_ids before", text)
        input_ids = self.tokenizer.encode(text)
        # print("input_ids after tokenizer", input_ids)
        user_input_ids = self.tokenizer.encode(user_inputs)
