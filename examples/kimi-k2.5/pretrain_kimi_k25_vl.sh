...
SEQ_LENGTH=${SEQ_LENGTH:-768}
DECODER_SEQ_LENGTH=${DECODER_SEQ_LENGTH:-1024}
...
Q_LORA_RANK=${Q_LORA_RANK:-512}
KV_LORA_RANK=${KV_LORA_RANK:-256}
QK_HEAD_DIM=${QK_HEAD_DIM:-128}
QK_POS_EMB_HEAD_DIM=${QK_POS_EMB_HEAD_DIM:-64}
V_HEAD_DIM=${V_HEAD_DIM:-128}

KIMI_VISION_NUM_LAYERS=${KIMI_VISION_NUM_LAYERS:-27}
KIMI_VISION_HIDDEN_SIZE=${KIMI_VISION_HIDDEN_SIZE:-1152}
KIMI_VISION_FFN_HIDDEN_SIZE=${KIMI_VISION_FFN_HIDDEN_SIZE:-4304}
KIMI_VISION_NUM_ATTENTION_HEADS=${KIMI_VISION_NUM_ATTENTION_HEADS:-16}
...
TOKENIZER_MODEL=${TOKENIZER_MODEL:-moonshotai/Kimi-K2.5}
